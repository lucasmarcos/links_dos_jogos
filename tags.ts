...
function renderTemplate(strings: TemplateStringsArray, values: TemplateValue[]): string {
...
export function css(strings: TemplateStringsArray, ...values: TemplateValue[]): string {
  return renderTemplate(strings, values);
}
